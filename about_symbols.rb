...
class AboutSymbols < Neo::Koan
  ...
  # Because symbol comparison checks the object_id and NOT the contents of the name itself. String comparison checks the contents of the string rather than the different object_ids
  ...
  # Symbols, when created, are given a unique object_id in memory and they stay there until the program ends. It is very wasteful to create a bunch of symbols.
